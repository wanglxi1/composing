...
public class GeneticAlgorithm<A> {
	...
	public GeneticAlgorithm(int individualLength, FiniteAlphabetBuilder<A> finiteAlphabet, double mutationProbability) {
		this(individualLength, finiteAlphabet, mutationProbability, new Random());
	}

	public GeneticAlgorithm(int individualLength, FiniteAlphabetBuilder<A> finiteAlphabet, double mutationProbability, Random random) {
